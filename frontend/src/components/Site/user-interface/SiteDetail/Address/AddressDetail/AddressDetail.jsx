...
const AddressDetail = ({client, handleSaveAddress}) => {
  ...
  return (
    <div className='lt-page' data-testid='address-detail-site-page'>
      <div className='lt-detail-header'>
        <div className='lt-detail-header-left'>
          <button className='lt-back-btn' onClick={handleBack} data-testid='address-site-back-btn'>
            <i className='pi pi-arrow-left'></i>
            <span style={{fontSize: '0.78rem', fontWeight: 600, color: '#475569'}}>Retour</span>
          </button>
          <div className='lt-detail-avatar'>
            <div className='lt-detail-avatar-ph' style={{background: '#DBEAFE', color: '#3B82F6'}}>
        ...
        <div className='lt-detail-actions-group'>
          <button
            data-testid='address-site-save-btn'
